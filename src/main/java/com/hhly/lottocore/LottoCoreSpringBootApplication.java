...
@MapperScan(basePackages = { "com.hhly.lottocore.persistence.**.dao" })
@ImportResource("classpath:transaction.xml")
@EnableEncryptableProperties
public class LottoCoreSpringBootApplication {
    ...
    public static void main(String[] args) {
        {
        	...
        	SpringApplication.run(LottoCoreSpringBootApplication.class, args);
        }
