...
@Component
public class Jxk3OrderDetailValidate extends K3OrderDetailValidate {
	...
	public void validateLotteryChildCode(OrderDetailVO orderDetailVO) {
		...
		Assert.isTrue(HighUtil.isJxk3(lotteryChildCode), MessageCodeConstants.LOTTERY_CHILD_CODE_IS_NULL_FIELD,lotteryChildCode);
	}
	...
	private static final LimitTranslator K3_LIMIT_TRANSLATOR = new LimitTranslator() {
		...
		public String translate(String originalLimitContent,Integer lotteryChildCode) {
			String translated;
			if(Objects.equals(lotteryChildCode, LotteryChildEnum.LotteryChild.JXK3_L3.getValue())){
				translated = originalLimitContent.replaceAll("3L", "三连号通选");
			}
			else if(Objects.equals(lotteryChildCode, LotteryChildEnum.LotteryChild.JXK3_TT3.getValue())) {
		...
		public boolean whetherTraslate(Integer lotteryChildCode) {
			...
			// 新加快三彩种要增加相应的子玩法判断
			return (
					Objects.equals(lotteryChildCode, LotteryChildEnum.LotteryChild.JXK3_L3.getValue()) ||
					Objects.equals(lotteryChildCode, LotteryChildEnum.LotteryChild.JXK3_TT3.getValue())
					);
		}
	};
