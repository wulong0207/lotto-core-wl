 ...
 */
@Component
public class Gx11x5OrderDetailValidate extends X115OrderDetailValidate {
	...
	public void validateLotteryChildCode(OrderDetailVO orderDetailVO) {
		...
		Assert.isTrue(HighUtil.isGX11x5(lotteryChildCode), MessageCodeConstants.LOTTERY_CHILD_CODE_IS_NULL_FIELD,lotteryChildCode);
	}
}
