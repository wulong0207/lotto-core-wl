...
@Component
public class Cqkl10OrderDetailValidate extends Kl10OrderDetailValidate {
	...
	public void validateLotteryChildCode(OrderDetailVO orderDetailVO) {
		...
		Assert.isTrue(HighUtil.isCqkl10(lotteryChildCode), MessageCodeConstants.LOTTERY_CHILD_CODE_IS_NULL_FIELD,lotteryChildCode);
	}
}
