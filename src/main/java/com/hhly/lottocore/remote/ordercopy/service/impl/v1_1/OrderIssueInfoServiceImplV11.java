...
@Service("orderIssueInfoServiceV11")
public class OrderIssueInfoServiceImplV11 implements OrderIssueInfoServiceV11 {
    private static Logger logger = LoggerFactory.getLogger(OrderIssueInfoServiceImplV11.class);

    @Autowired
    private IPageService pageService;

    @Autowired
    private OrderIssueInfoDaoMapperV11 orderIssueInfoDaoMapper;
