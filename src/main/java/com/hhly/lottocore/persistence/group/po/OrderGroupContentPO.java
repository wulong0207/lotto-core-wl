...
//    public OrderGroupContentPO(){}
//    public OrderGroupContentPO(OrderGroupContentVO orderGroupContentVO){
//        this.orderCode = orderGroupContentVO.getOrderCode();
//        this.userId = orderGroupContentVO.getUserId();
//        this.buyAmount = orderGroupContentVO.getBuyAmount();
//        this.buyRatio = orderGroupContentVO.getBuyRatio();
//        this.buyTime = orderGroupContentVO.getBuyTime();
//        this.preBonus = orderGroupContentVO.getPreBonus();
//        this.aftBonus = orderGroupContentVO.getAftBonus();
//        this.commissionAmount = orderGroupContentVO.getCommissionAmount();
//        this.sendBonus = orderGroupContentVO.getSendBonus();
//        this.createTime = orderGroupContentVO.getCreateTime();
//        this.updateTime = orderGroupContentVO.getUpdateTime();
//    }
