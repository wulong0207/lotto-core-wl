package com.hhly.lottocore.persistence.group.po;

import com.hhly.skeleton.base.util.ObjectUtil;
import com.hhly.skeleton.lotto.base.group.vo.OrderGroupInfoVO;
import com.hhly.skeleton.lotto.base.group.vo.OrderGroupVO;
...
public class OrderGroupPO {
    ...
    public OrderGroupPO(){}
    public OrderGroupPO(OrderGroupInfoVO orderGroupInfoVO){
        //非空字段
        this.userId = orderGroupInfoVO.getUserId();
        this.orderCode = orderGroupInfoVO.getOrderCode();
        this.grpbuyStatus = orderGroupInfoVO.getGrpbuyStatus();
        this.minBuyRatio = orderGroupInfoVO.getMinBuyRatio();
        this.minBuyAmount = orderGroupInfoVO.getMinBuyAmount();
        this.guaranteeRatio= orderGroupInfoVO.getGuaranteeRatio();
        this.guaranteeAmount = orderGroupInfoVO.getGuaranteeAmount();
        this.visibleType = orderGroupInfoVO.getVisibleType();
        this.commissionRatio = orderGroupInfoVO.getCommissionRatio();
        this.applyWay = orderGroupInfoVO.getApplyWay();
        this.isTop = orderGroupInfoVO.getIsTop();
        //
        this.commissionAmount = orderGroupInfoVO.getCommissionAmount();
        this.applyCode = orderGroupInfoVO.getApplyCode();
        this.title = orderGroupInfoVO.getTitle();
        this.description = orderGroupInfoVO.getDescription();
        this.isRecommend = orderGroupInfoVO.getIsRecommend();
        this.progress = orderGroupInfoVO.getProgress();
        this.progressAmount = orderGroupInfoVO.getProgressAmount();
        this.buyCount = orderGroupInfoVO.getBuyCount();
        this.remark = orderGroupInfoVO.getRemark();
        this.updateTime = orderGroupInfoVO.getUpdateTime();
        this.createTime = orderGroupInfoVO.getCreateTime();
    }
