...
public class OrderIssueInfoPO {
    ...
    public OrderIssueInfoPO() {
    }

    public OrderIssueInfoPO(OrderIssueInfoVO vo) {
        this.id = vo.getId();
        this.userIssueId = vo.getUserIssueId();
        this.orderCode = vo.getOrderCode();
        this.maxRoi = vo.getMaxRoi();
        this.recommendReason = vo.getRecommendReason();
        this.isShow = vo.getIsShow();
        this.orderVisibleType = vo.getOrderVisibleType();
        this.commissionRate = vo.getCommissionRate();
